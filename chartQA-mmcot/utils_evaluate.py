...
'''
# --- HuggingFace compatibility shim ---
import importlib
...
try:
    ...
    raise ImportError("huggingface_hub is not installed. Please install it via pip.")

# If cached_download is missing, patch it
if not hasattr(huggingface_hub, "cached_download"):
    def cached_download(*args, **kwargs):
        """Shim for backward compatibility with sentence-transformers"""
